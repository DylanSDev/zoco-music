...
export function TopResultCard({ name, subtitle, type, imageUrl, isAlbum = false, id, typeRoute }) {
  ...
  return (
    <div 
      onClick={handleClick}
      className="group relative flex h-full min-h-[200px] md:min-h-[250px] cursor-pointer flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0F2A3B]/40 p-3 sm:p-4 lg:p-6 transition-all duration-300 hover:border-[#F1FF00]/50 hover:bg-[#0F2A3B]/60 hover:shadow-[0_0_30px_rgba(241,255,0,0.15)]"
    >
      ...
      <div className="relative z-10 flex flex-col items-start gap-2 lg:gap-3 h-full justify-between">
        <div className="w-full aspect-square overflow-hidden rounded-2xl border-2 border-transparent transition-all duration-300 group-hover:border-[#F1FF00]/50 group-hover:shadow-neon shadow-lg">
